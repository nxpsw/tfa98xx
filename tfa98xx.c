...
{
#if defined(TFA_CHECK_CALIBRATE_DONE) || defined(TFA_DBGFS_CHECK_MTPEX)
...
#else
	// tfa98xx->tfa->dev_ops.dsp_msg = (dsp_send_message_t)...;
	// tfa98xx->tfa->dev_ops.dsp_msg_read = (dsp_read_message_t)...;
#endif
#endif
